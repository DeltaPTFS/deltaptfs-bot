...
function loadConfig(environment = process.env) {
  ...
  return Object.freeze({
    ...
    moderationLeadershipRoleId: environment.MODERATION_LEADERSHIP_ROLE_ID || '1539005030189891684',
    moderationFounderRoleId: environment.MODERATION_FOUNDER_ROLE_ID || '1539005297417519205',
...
function mergeGuildConfig(base, stored) {
  ...
  return {
    ...base,
    ...stored,
    authenticatedRoleId: stored.authenticatedRoleId || base.authenticatedRoleId,
    unauthenticatedRoleId: stored.unauthenticatedRoleId || base.unauthenticatedRoleId,
    logChannelId: stored.logChannelId || base.logChannelId,
    robloxGroupId: stored.robloxGroupId || base.robloxGroupId,
    roleMappings,
