...
All information-message icons use standard Unicode emoji, so they render without requiring server-specific custom emoji IDs. This includes the headings as well as the application link, HelpDesk link, and closing line.
